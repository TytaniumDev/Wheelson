...
describe("CommunityService", function()
    ...
    describe("ValidateCommunityName", function()
        ...
        it("should reject names with numbers in character portion", function()
            local ok = WHLSN:ValidateCommunityName("Tyler123")
            assert.is_false(ok)
        end)

        it("should accept realm names with numbers", function()
            local ok = WHLSN:ValidateCommunityName("Tyler-Area52")
            assert.is_true(ok)
        end)
        ...
        it("should accept names with umlaut characters", function()
            assert.is_true(WHLSN:ValidateCommunityName("Müzaka"))
            assert.is_true(WHLSN:ValidateCommunityName("Ärthás"))
            assert.is_true(WHLSN:ValidateCommunityName("Björk"))
        end)

        it("should accept names with acute and grave accents", function()
            assert.is_true(WHLSN:ValidateCommunityName("Élowen"))
            assert.is_true(WHLSN:ValidateCommunityName("Àrianë"))
            assert.is_true(WHLSN:ValidateCommunityName("Óríon"))
        end)

        it("should accept names with circumflex and cedilla", function()
            assert.is_true(WHLSN:ValidateCommunityName("Rôgûe"))
            assert.is_true(WHLSN:ValidateCommunityName("Françoise"))
        end)

        it("should accept names with tilde and ring", function()
            assert.is_true(WHLSN:ValidateCommunityName("Señor"))
            assert.is_true(WHLSN:ValidateCommunityName("Ñoño"))
            assert.is_true(WHLSN:ValidateCommunityName("Åsa"))
        end)

        it("should accept names with ligatures", function()
            assert.is_true(WHLSN:ValidateCommunityName("Ælfred"))
            assert.is_true(WHLSN:ValidateCommunityName("Cœur"))
        end)

        it("should accept names starting with accented character", function()
            assert.is_true(WHLSN:ValidateCommunityName("Übermensch"))
            assert.is_true(WHLSN:ValidateCommunityName("Ísildur"))
        end)

        it("should accept accented names with realm", function()
            assert.is_true(WHLSN:ValidateCommunityName("Müzaka-Illidan"))
            assert.is_true(WHLSN:ValidateCommunityName("Élowen-Area52"))
            assert.is_true(WHLSN:ValidateCommunityName("Señor-Kel'Thuzad"))
        end)
